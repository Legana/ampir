...
#It still doesnt work, even though I made this model inside this workspace, it gives me the same error.
#there's no rownames and the column names are the same ("label") excluded - so why doesn't it work?)
predict("svmRadialwithprob2", little_features, type = "prob")
...
predict(get("svmRadialwithprob2"), little_features, type = "prob")
```
